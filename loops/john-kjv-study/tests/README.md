...
| `fixtures/john-02.minimal.md`, `fixtures/john-00.minimal.md` | A chapter unit and an overview that keep every rule of the KJV72 × KJV82 format with brief prose, so each passes every check except LENGTH. Each mutation test breaks one rule and expects its code. |
