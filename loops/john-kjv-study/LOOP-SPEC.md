...
| HUMAN | `.loop-stop` exists · 3 drafts are waiting for review (no new unit starts) · chapter units wait until unit 00 is approved (KJV82's Blueprint checkpoint, `BLUEPRINT_CHECKPOINT`) · every unit waits for your approval |
