...
**Transliterations.** Five of the lexicon's 9,549 Greek entries give a transliteration that contradicts their own Greek lemma. One matters for John: the noun ἱερόν, *hieron* (G2411, John 2:15), is given the adjective's spelling, 'hieros'. Another 24 write a diphthong's rough breathing inside it ('ohutos' for οὗτος, *houtos* (G3778, John 1:2)). The data file keeps the source's text. The tools transliterate the Greek itself (`kjvlib.greek_translit`): `tools/lexicon.py` prints the corrected form with a note, and the checker accepts the Greek's own spelling and refuses a transliteration that contradicts it (`LOOP-SPEC.md`, SF-10). The Greek text file has a quirk of its own: it writes eta with iota subscript as 'ēa' ('elegchthēa' for ἐλεγχθῇ, *elegchthē* (G1651, John 3:20)), in 1,468 words. The tools print the Greek's own spelling there too, with a note, and the checker holds to it (SF-14).
